...
export const operatorProvider = vscode.languages.registerCompletionItemProvider(
	't',
	{
		provideCompletionItems(document : vscode.TextDocument, position : vscode.Position) {
			...
			completionArray.push(operatorCompletion(
				'+',
				'Adds two variables of either real, nat, or int type',
				'Add 2 numbers'
			));

			completionArray.push(operatorCompletion(
				'-',
				'Subtracts one number from another to produce a result of type real or int',
				'Subtraction'
			));

			completionArray.push(operatorCompletion(
				'*',
				'Multiplies two numbers together to get one number of type real or int',
				'Multiplication'
			));

			completionArray.push(operatorCompletion(
				'/',
				'Divides two numbers and outputs as a real number',
				'Decimal division'
			));

			completionArray.push(operatorCompletion(
				'**',
				'The exponentiation operator puts real and integer\'s to the exponent of another real or integer type',
				'Exponentiation'
			));

			completionArray.push(operatorCompletion(
				'<',
				'The less than operator is true when the left side is smaller than the right',
				'Less than'
			));

			completionArray.push(operatorCompletion(
				'>',
				'The Greater than operator is true when the left side is larger than the right',
				'Greater than'
			));

			completionArray.push(operatorCompletion(
				'=',
				'The equal to operator is true when both sides are equal',
				'Equal to'
			));

			completionArray.push(operatorCompletion(
				'<=',
				'The less or equal to operator is true when the left side is smaller or equal to than the right',
				'Less or equal to'
			));

			completionArray.push(operatorCompletion(
				'>=',
				'The greater or equal to operator is true when the left side is larger or equal to than the right',
				'Greater or equal to'
			));

			completionArray.push(operatorCompletion(
				'not',
				'The not operator inverts boolean values. For example, not true is equal to false',
				'Not (invert)'
			));
