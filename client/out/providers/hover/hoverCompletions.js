...
exports.hover = exports.constRegex = exports.functionRegex = exports.stringRegex = exports.numberRegex = exports.keywordRegex = exports.moduleRegex = exports.moduleSubRegex = exports.operatorRegex = void 0;
...
function hover(descText, turingText, prefixText, parameters, parameterDesc, returnsDesc) {
    ...
    if (prefixText)
        hovers[0].appendCodeblock(prefixText + ' ' + turingText); // Append prefix and syntax if prefix is passed in
    else if (turingText)
        hovers[0].appendCodeblock(turingText); // Append in syntax if it's passed in
    ...
    if (returnsDesc)
        hovers.push(new vscode.MarkdownString().appendMarkdown(`_@return_ — ${returnsDesc}`)); // Add return
